...
(function (g, y) {
	...
	function Ca(b) {
		if (S.useDeprecatedSynchronousErrorHandling) {
			...
			if (
				a &&
				((a = V), (b = a.errorThrown), (a = a.error), (V = null), b)
			)
				throw a;
		} else b();
	}
	...
	function ce(b) {
		var a;
		(a = b && b instanceof oa) ||
			(a = b && q(b.next) && q(b.error) && q(b.complete) && Hb(b));
		return a;
	}
	function n(b) {
		return function (a) {
	...
	function Nb(b) {
		return b in Za ? (delete Za[b], !0) : !1;
	}
	function de(b) {
	...
	function Qb(b) {
		return q(null === b || void 0 === b ? void 0 : b[$a]);
	}
	function Rb(b) {
	...
	function t(b) {
		...
		if (null != b) {
			if (q(b[qa])) return ee(b);
			if (ab(b)) return fe(b);
			if (q(null === b || void 0 === b ? void 0 : b.then)) return ge(b);
			if (Ob(b)) return Sb(b);
			if (Qb(b)) return he(b);
	...
	function X(b) {
		return P(function (a) {
			return le(a) ? b.apply(void 0, z([], x(a))) : b(a);
		});
	}
	function Ha(b, a, c, d) {
		if (c)
	...
	function Na(b, a) {
		return a
			? function (c) {
					return ua(a.pipe(ha(1), nb()), c.pipe(Na(b)));
			  }
			: H(function (a, d) {
					return b(a, d).pipe(ha(1), ob(a));
			  });
	}
	function xc(b, a) {
		void 0 === a && (a = I);
	...
	function Cc() {
		for (var b = [], a = 0; a < arguments.length; a++) b[a] = arguments[a];
		return function (a) {
			return ua(a, bb.apply(void 0, z([], x(b))));
		};
	}
	function Dc(b, a) {
		return n(function (c, d) {
			...
			a.subscribe(
				m(
					...
					function (l) {
						f = !0;
						if (!b || b(l, h++, a))
							d && c.error(new jd("Too many matching values")),
								(d = !0),
								(e = l);
					},
					function () {
						d
							? (c.next(e), c.complete())
							: c.error(
									f ? new kd("No matching values") : new ba()
							  );
					}
				)
			);
		...
		return n(function (a, e) {
			...
			a.subscribe(
				m(e, function (a) {
					k &&
						((a = z([a], x(h))),
						e.next(c ? c.apply(void 0, z([], x(a))) : a));
				})
			);
		});
	}
	...
	function Id() {
		...
		return n(function (a, d) {
			ib.apply(void 0, z([a], x(b))).subscribe(d);
		});
	}
	function Jd() {
		for (var b = [], a = 0; a < arguments.length; a++) b[a] = arguments[a];
		return Id.apply(void 0, z([], x(b)));
	}
	function Kd(b, a) {
	...
	function Le(b, a) {
		return Me(ca({method: "GET", url: b, headers: a}));
	}
	function Ne(b) {
		return new p(function (a) {
			var c,
			...
			h = function (b, c) {
				u.addEventListener(b, function () {
					var b,
						d = c();
					null ===
						(b = null === p || void 0 === p ? void 0 : p.error) ||
					void 0 === b
						? void 0
						: b.call(p, d);
					a.error(d);
			...
			var t = function (b, c, d) {
				b.addEventListener(c, function (b) {
					a.next(new xb(b, u, q, d + "_" + b.type));
				});
			};
			d &&
				[yb, zb, Nd].forEach(function (a) {
					return t(u.upload, a, Pe);
				});
			p &&
			...
			var x = function (b) {
				a.error(new xa("ajax error" + (b ? " " + b : ""), u, q));
			};
			...
			u.addEventListener(Nd, function (b) {
				...
				if (400 > e) {
					null ===
						(c =
							null === p || void 0 === p ? void 0 : p.complete) ||
					void 0 === c
						? void 0
						: c.call(p);
					c = void 0;
					try {
						c = new xb(b, u, q, Od + "_" + b.type);
					} catch (ye) {
						a.error(ye);
						return;
					}
	...
	var Ua = function (b, a) {
			...
			b.prototype.add = function (a) {
				...
				if (a && a !== this)
					if (this.closed) q(a) ? a() : a.unsubscribe();
						...
						(this._finalizers =
							null !== (c = this._finalizers) && void 0 !== c
								? c
								: []).push(a);
					}
			};
			...
			function a(a, d, e) {
				...
				q(a) || !a
					...
					: c &&
					  ...
					  (a = {
							next: a.next && Bb.call(a.next, d),
							error: a.error && Bb.call(a.error, d),
							complete: a.complete && Bb.call(a.complete, d),
					  }));
		...
		Ze = (function (b) {
			...
			a.prototype.requestAsyncId = function (a, d, e) {
				...
				return (
					a._scheduled ||
					(a._scheduled = T.requestAnimationFrame(function () {
			...
			a.prototype.recycleAsyncId = function (a, d, e) {
				...
				a.actions.some(function (a) {
					return a.id === d;
				}) || (T.cancelAnimationFrame(d), (a._scheduled = void 0));
			};
			return a;
		})(za),
		Td = new ((function (b) {
	...
	var Qa = (function () {
		...
		af = Object.freeze({
			...
			race: function () {
				for (var b = [], a = 0; a < arguments.length; a++)
					b[a] = arguments[a];
				return sb.apply(void 0, z([], x(aa(b))));
			},
			raceWith: sb,
			reduce: ga,
			repeat: ad,
	...
	g.isObservable = function (b) {
		return !!b && (b instanceof p || (q(b.lift) && q(b.subscribe)));
	};
	...
	g.merge = function () {
		...
		return b.length ? (1 === b.length ? t(b[0]) : ta(c)(O(b, a))) : K;
	};
	g.never = function () {
		return Vd;
	};
	...
	g.pairs = function (b, a) {
		return O(Object.entries(b), a);
	};
	g.partition = function (b, a, c) {
		return [L(a, c)(t(b)), L(gc(a, c))(t(b))];
	};
	g.race = function () {
		for (var b = [], a = 0; a < arguments.length; a++) b[a] = arguments[a];
		b = aa(b);
